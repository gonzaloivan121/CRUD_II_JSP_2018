...
--
-- Servidor: localhost
-- Tiempo de generación: 10-05-2018 a las 13:55:00
...
INSERT INTO `producto` (`codigo_producto`, `nombre`, `modelo`, `instrumento`, `marca`, `precio`) VALUES
(1, 'Epiphone Special II Pro White', 'Special II Pro', 'Guitarra Eléctrica', 'Epiphone', 401),
(3, 'Schecter Demon-7 Satin Black SBK', 'Demon-7 Satin Black SBK', 'Guitarra Eléctrica', 'Schecter', 510),
(4, 'Schecter Diamond Omen 7 Extreme', 'Diamond Omen 7 Extreme BCH', 'Guitarra Eléctrica', 'Schecter', 444),
(5, 'Mapex Black Panther Blaster Set', 'Black Panther Blaster Set', 'Batería Acústica', 'Mapex', 2799),
(6, 'Yamaha Recording Custom Studio RW', 'Recording Custom Studio RW', 'Batería Acústica', 'Yamaha', 3190),
(7, 'Yamaha Recording Custom Standard SFG', 'Recording Custom Standard SFG', 'Batería Acústica', 'Yamaha', 3444),
(8, 'Fender AM Elite Jazz Bass RW 3TSB', 'AM Elite Jazz Bass RW 3TSB', 'Bajo Eléctrico', 'Fender', 2080),
(9, 'Fender AM Elite JazzBass V ASH MN NAT', 'AM Elite JazzBass V ASH MN NAT', 'Bajo Eléctrico', 'Fender', 2222),
(11, 'Tama Star Drum Bubinga Rock KNFB', 'Star Drum Bubinga Rock KNFB', 'Batería Acústica', 'Tama', 6111),
(12, 'DS Drums Rebel Maple Exotic Green Ebony', 'Rebel Maple Exotic Green Ebony', 'Batería Acústica', 'DS Drums', 3899);
...
--
ALTER TABLE `producto`
  MODIFY `codigo_producto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
--
